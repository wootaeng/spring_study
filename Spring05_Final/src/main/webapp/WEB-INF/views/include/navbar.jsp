 ...
 <nav class="navbar navbar-dark bg-primary navbar-expand-sm fixed-top" >
 	<div class="container">
	  	<a class="navbar-brand" href="${pageContext.request.contextPath }/">
	  		<img style="width:70px;height:50px" src="${pageContext.request.contextPath }/resources/images/404.jpg"/> 
	  	</a>
		...
		<div class="collapse navbar-collapse" id="topNav">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item ${param.thipage eq 'cafe' ? 'active' : ''}">
					<a class="nav-link" href="${pageContext.request.contextPath }/cafe/list.do">게시글 목록</a>
				</li>
				<li class="nav-item ${param.thipage eq 'file' ? 'active' : ''}">
					<a class="nav-link" href="${pageContext.request.contextPath }/file/list.do">자료실</a>
				</li>
				<li class="nav-item ${param.thipage eq 'gallery' ? 'active' : ''}">
			...
			<c:choose>
				<c:when test="${empty sessionScope.id }">
					...
					<a class="btn btn-danger btn-sm ml-1" href="${pageContext.request.contextPath }/users/signup_form.do">회원가입</a>
				</c:when>
				<c:otherwise>
